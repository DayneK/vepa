...
> **Audit Hash:** `AGENTS_SYNC_v9.1.13_2026-09-20`
>
...
| **Active version** | **VEPA4 v9.1.13** (legacy label `4.9.15`) — systems atlas for organization, reproduction, lineage, culture, civilization proxies, and relationship-laboratory analysis |
...
`VERSION`, the changelog top section's arrow token, and `package.json#version` MUST all equal the newest version (`9.1.13`). From here on, drift is a release
blocker.
