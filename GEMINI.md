...
- The product is **VEPA4**; every version uses the **`major.minor.build`** schema (current `9.1.22`), with legacy labels retained in `CHANGELOG.md` headers (old `4.M.N` → `M.N.0`).
